	...
	$.fn.fcbkcomplete = function(opt) {
		return this.queue(function() {
			...
			function createFCBK() {
				...
				complete = $('<div class="facebook-auto" style = "width: auto">');
					...
					complete.children(".default").hide();
						if(!holder.children("li.bit-box:last").hasClass('locked')) {
							if(holder.children("li.bit-box.deleted").length == 0) {
								...
								deleting = 1;
								holder.children("li.bit-box.deleted").fadeOut("fast", function() {removeItem($(this));
									return false
								})
							}
						}
			...
			function bindEvents() {
				...
				feed.children("li").unbind("mousedown").mousedown(function() {
					...
					clear_feed(1);
					complete.children(".default").hide();//new
					complete.hide()
				});
