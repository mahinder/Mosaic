...
class FeeDiscount < ActiveRecord::Base
  ...
  validates :name, :discount, :type,:batch_id ,:presence => true
  # validates_numericality_of :discount,:less_than_or_equal_to=> 100,:greater_than_or_equal_to=> 1
  #enoch - numericality syntax changed
  validates :discount, :numericality => true, :numericality => {:greater_than_or_equal_to => 1 ,:less_than_or_equal_to => 100}
