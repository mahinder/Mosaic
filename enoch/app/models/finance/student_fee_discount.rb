...
class StudentFeeDiscount < FeeDiscount
  ...
  # validates  :receiver_id , :message => "Student Admission number cant be blank"

  validates :receiver_id , :presence => {:message => "Student Admission number cant be blank"}
  validates :finance_fee_category_id,:presence => true


  # validates :name, :uniqueness => true
  validates :name, :uniqueness => { :scope=>[:receiver_id ]}
