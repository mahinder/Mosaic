...
(function($)
{
	...
	$.fn.blockMessage = function(message, options)
	{
		...
		this.each(function(i)
		{
			...
			//enoch - modified to include close-button in the block message 
			// var finalMessage = (typeof message == 'object') ? '<ul class="'+messageClass+'"><li>'+message.join('</li><li>')+'</li></ul>' : '<p class="'+messageClass+'">'+message+'</p>';
			var finalMessage = (typeof message == 'object') ? '<ul class="'+messageClass+'"><li>'+message.join('</li><li>')+'</li></ul>' : '<ul class="' + messageClass + '"> <li>' + message + '</li> <li class="close-bt"></li></ul';
			// Insert message
